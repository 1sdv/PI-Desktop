...
- Bundled plugin `pi.advisor` proves the channel: `/advisor` picks a reviewer;
  the executor calls `plugin_pi_advisor_advisor` for a second opinion.
